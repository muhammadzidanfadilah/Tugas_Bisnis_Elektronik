...
<head>
	...
	<title>TOKO ONLINE WRG-ZIDAN</title>
...
.toko-title {
    font-size: 36px; /* Ukuran huruf lebih besar */
    font-weight: bold;
    margin-left: 10px;
    color: #E74C3C; /* Warna teks (misalnya biru) */
    text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); /* Efek bayangan teks */
    letter-spacing: 1px; /* Spasi antar huruf */
}

/* Efek hover untuk menambah interaktivitas */
.toko-title:hover {
    color: #e74c3c; /* Warna berubah saat dihover (misalnya merah) */
}
			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-logo">
						<a class="logo" href="#">
						<span class="toko-title">WRG-ZIDAN</span>
						</a>
