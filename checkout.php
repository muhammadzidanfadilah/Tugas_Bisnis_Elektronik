								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="form-group">
											...
											<textarea name="alamat" class="form-control" style="resize: none;" rows="6" placeholder="Masukkan alamat lengkap Jika berada dekat toko jangan masukan provinsi dan kabupaten / COD = Alamat.."></textarea>
										</div>
